 ...
 * Создает .html файлы напрямую (без папок) чтобы избежать 301 редиректов
 */
...
function generateStaticFiles() {
  ...
  routes.forEach(route => {
    ...
    // Создаем .html файл напрямую (без папок!)
    const filePath = path.join(distPath, `${route.file}.html`);
    
    // Создаем директорию если нужна (например calculator/)
  ...
  console.log('\n💡 Теперь выполните:');
  console.log('   git add dist/ && git commit -m "Add static HTML files" && git push');
  console.log('\n🌐 Страницы будут доступны без 301 редиректов!');
}

// Запуск
console.log('========================================');
console.log('   Генератор статических HTML файлов');
console.log('   для GitHub Pages (без 301!)');
console.log('========================================\n');
