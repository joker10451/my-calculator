...
export const AFFILIATE_LINKS: Record<string, AffiliateLink> = {
  ...
  'pampadu-osago': {
    url: 'https://pampadu.ru/osago-widget?agent=a263585',
    bankId: 'pampadu',
    productType: 'insurance',
    description: 'Сравнение стоимости ОСАГО у 25+ страховых компаний онлайн',
    title: 'Pampadu — сравнить ОСАГО',
    category: 'insurance',
    badges: ['ОСАГО', 'Автострахование'],
    updatedAt: '2026-04-11',
    eligibility: ['Для владельцев авто', 'Онлайн-оформление'],
    publicDetails: 'Сравнение тарифов и выбор подходящего полиса ОСАГО',
    priority: 97,
  },
  'pampadu-kasko': {
    url: 'https://pampadu.ru/kasko?agent=a263585',
    bankId: 'pampadu',
    productType: 'insurance',
    description: 'Подбор предложений КАСКО с онлайн-расчетом стоимости',
    title: 'Pampadu — рассчитать КАСКО',
    category: 'insurance',
    badges: ['КАСКО', 'Автострахование'],
    updatedAt: '2026-04-11',
    eligibility: ['Для владельцев авто', 'Онлайн-сравнение условий'],
    publicDetails: 'Подбор полиса КАСКО по параметрам автомобиля',
    priority: 96,
  },
  'pampadu-mortgage': {
    url: 'https://pampadu.ru/hypothec-insurance?agent=a263585',
    bankId: 'pampadu',
    productType: 'insurance',
    description: 'Ипотечное страхование: сравнение цен и оформление полиса дешевле, чем в банке',
    title: 'Pampadu — страхование ипотеки',
    category: 'insurance',
    badges: ['Ипотека', 'Страхование'],
    updatedAt: '2026-04-11',
    eligibility: ['Граждане РФ', 'При наличии ипотеки'],
    publicDetails: 'Полис принимается банком (аккредитованные компании)',
    priority: 95,
  },
  'pampadu-credit': {
    url: 'https://pampadu.ru/credit-cards?agent=a263585',
    bankId: 'pampadu',
    productType: 'credit',
    description: 'Сравнение и подбор кредитных карт: до 365 дней без процентов, высокий кэшбэк',
    title: 'Pampadu — кредитные карты',
    category: 'credit',
    badges: ['Кредитка', 'Подбор'],
    updatedAt: '2026-04-11',
    eligibility: ['Возраст 18+', 'Паспорт РФ'],
    publicDetails: 'Выбор из десятков предложений ведущих банков',
    priority: 94,
  },
  'pampadu-microloans': {
    url: 'https://pampadu.ru/microloans?agent=a263585',
    bankId: 'pampadu',
    productType: 'loan',
    description: 'Онлайн-займы без отказа: подбор предложений под 0% для новых клиентов',
    title: 'Pampadu — микрозаймы (МФО)',
    category: 'loan',
    badges: ['Займ 0%', 'Онлайн'],
    updatedAt: '2026-04-11',
    eligibility: ['Возраст 18+', 'Паспорт РФ'],
    publicDetails: 'Моментальное решение и перевод на карту',
    priority: 85,
  },
  'pampadu-health': {
    url: 'https://pampadu.ru/health-insurance?agent=a263585',
    bankId: 'pampadu',
    productType: 'insurance',
    description: 'Медицинское страхование: полисы ОМС/ДМС, страхование от клеща и несчастных случаев',
    title: 'Pampadu — страхование здоровья',
    category: 'insurance',
    badges: ['Здоровье', 'ДМС'],
    updatedAt: '2026-04-11',
    eligibility: ['Граждане РФ'],
    publicDetails: 'Широкий выбор программ страхования жизни и здоровья',
    priority: 90,
  },
  'sber-insurance-all': {
