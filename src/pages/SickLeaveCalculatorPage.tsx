...
const SickLeaveCalculatorPage = () => {
    ...
    return (
        <CalculatorPageWrapper
            seoTitle="Калькулятор больничного 2026 — расчет пособия по нетрудоспособности"
            seoDescription="Калькулятор больничного 2026: рассчитайте пособие по нетрудоспособности с учетом стажа и среднего заработка. Правила ФСС — онлайн и бесплатно."
            seoKeywords="калькулятор больничного, расчет больничного 2026, больничный лист онлайн, пособие по нетрудоспособности, больничный стаж, максимальный больничный, больничный НДФЛ"
            ...
            aboutTitle="Как рассчитать больничный лист в 2026 году"
            aboutDescription="Больничный лист — это пособие по временной нетрудоспособности, выплачиваемое работнику на время болезни или ухода за больным. Размер пособия зависит от страхового стажа: при стаже до 5 лет — 60% среднего заработка, от 5 до 8 лет — 80%, от 8 лет — 100%. Средний заработок рассчитывается за 2 предыдущих года. Первые 3 дня больничного оплачивает работодатель, остальные — ФСС. Максимальный дневной заработок в 2026 году ограничен предельной базой ФСС. Пособие облагается НДФЛ 13%."
