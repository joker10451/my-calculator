...
const DepositCalculatorPage = () => {
    const faqItems = [
        ...
        },
        {
            ...
            answer: "В апреле 2026 года при ключевой ставке 15% вклады предлагаются под 14–19% годовых. Лучшие ставки (17–19%) — у небольших банков на срок 1–2 года. Сбербанк и крупные банки дают 14–16%. Не забудьте: проценты свыше не облагаемого минимума (1 млн × 15% = 150 000 ₽) облагаются НДФЛ 13%."
        },
        {
    ...
    return (
        <CalculatorPageWrapper
            seoTitle="Калькулятор вкладов 2026 — доходность с капитализацией, сравнение банков, налог"
            seoDescription="Калькулятор вкладов 2026: рассчитайте доходность депозита с капитализацией и пополнением. Актуальные ставки банков — бесплатно и онлайн."
