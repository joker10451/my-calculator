...
const VacationCalculatorPage = () => {
    ...
    return (
        <CalculatorPageWrapper
            seoTitle="Калькулятор отпускных 2026 — расчет онлайн по ТК РФ"
            seoDescription="Калькулятор отпускных 2026: рассчитайте сумму отпускных по среднему заработку. НДФЛ, компенсация при увольнении — формула по Трудовому кодексу."
            seoKeywords="калькулятор отпускных, расчет отпускных 2026, отпускные онлайн, средний заработок, отпускные НДФЛ, компенсация отпуска, сколько отпускных"
            ...
            aboutTitle="Как рассчитать отпускные в 2026 году"
            aboutDescription="Отпускные — это оплата ежегодного оплачиваемого отпуска, который составляет минимум 28 календарных дней. Расчёт производится по формуле: средний дневной заработок × количество дней отпуска. Средний заработок считается за 12 месяцев, делится на 12 и на 29,3 (среднее число дней в месяце). При расчёте учитываются зарплата, премии и надбавки. Отпускные облагаются НДФЛ 13%. Выплачиваются не позднее чем за 3 дня до начала отпуска. Компенсация возможна только за дни свыше 28."
