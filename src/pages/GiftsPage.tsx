  ...
  return (
    <div className="min-h-screen bg-slate-950">
      <SEO
        ...
        description="Выберите подарок: подарочные сертификаты, наборы и惊喜 от партнёров. Удобный подбор и оформление онлайн."
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8 text-center">
            ...
            <p className="text-slate-300 mt-2">
              Подарочные сертификаты, наборы и惊喜 от наших партнёров
            </p>
          </div>
