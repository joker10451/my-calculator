      ...
      <div className="max-w-4xl mx-auto">
        ...
        {favoriteItems.length === 0 ? (
          <div className="text-center py-20">
            ...
            <h2 className="text-xl font-bold text-slate-700 dark:text-slate-300 mb-2">Пока пусто</h2>
            <p className="text-slate-500 dark:text-slate-400 mb-6">
              Нажмите <Heart className="w-4 h-4 inline text-red-500" /> на любом калькуляторе, чтобы добавить его в избранное
            </p>
            <Link
              to="/all"
