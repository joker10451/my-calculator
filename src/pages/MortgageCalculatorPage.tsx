...
const MortgageCalculatorPage = () => {
  const faqItems = [
    ...
    },
    {
      ...
      answer: "В апреле 2026 года базовая ставка по ипотеке — 14–16% годовых при первоначальном взносе от 20%. Льготные программы: семейная ипотека — 6%, IT-ипотека — 5%, дальневосточная — 2%. Без страхования жизни банк добавляет 1–2% к ставке."
    },
    {
  ...
  return (
    <CalculatorPageWrapper
      seoTitle="Ипотечный калькулятор 2026 — ставка 16%, досрочное погашение, Маткапитал"
      seoDescription="Ипотечный калькулятор 2026: рассчитайте ежемесячный платеж при ставке 16%, досрочное погашение, переплату. Маткапитал, семейная ипотека — онлайн и бесплатно."
