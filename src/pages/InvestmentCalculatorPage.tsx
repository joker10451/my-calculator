...
const InvestmentCalculatorPage = () => {
    ...
    return (
        <CalculatorPageWrapper
            ...
            seoDescription="Калькулятор инвестиций 2026: рассчитайте доходность вложений с сложным процентом, пополнением и инфляцией. Прогноз роста капитала — бесплатно."
