...
const CreditCalculatorPage = () => {
    const faqItems = [
        ...
        },
        {
            ...
            answer: "В апреле 2026 года при ключевой ставке ЦБ 15% потребительские кредиты выдаются под 16–25% годовых. Зарплатным клиентам — от 14%, новым клиентам — 18–25%. ПСК (полная стоимость) часто на 2–4% выше заявленной ставки из-за комиссий и страховки."
        }
    ];
    ...
    return (
        <CalculatorPageWrapper
            seoTitle="Кредитный калькулятор 2026 — аннуитетный и дифференцированный платёж, график"
            seoDescription="Кредитный калькулятор 2026: рассчитайте ежемесячный платеж, переплату и график погашения. Аннуитетные и дифференцированные платежи — бесплатно и онлайн."
