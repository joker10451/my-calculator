          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                a: 'Новым считается курьер, который выполнил последний заказ в Яндекс.Еде не менее 60 дней назад.',
              },
              {
                q: 'Что такое целевое действие (ЦД)?',
                a: 'ЦД считается выполненным, если с момента регистрации и выполнения 5 заказов прошло не более 14 дней.',
              },
              {
