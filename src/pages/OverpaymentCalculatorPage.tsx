...
const howToSteps = [
    { name: 'Введите сумму кредита', text: 'Укажите сколько хотите взять в банке', url: `${SITE_URL}/calculator/overpayment#amount` },
    { name: 'Укажите ставку', text: 'Введите текущую ставку или ту, что предлагает банк', url: `${SITE_URL}/calculator/overpayment#rate` },
    { name: 'Выберите срок', text: 'Укажите на сколько лет берёте ипотеку', url: `${SITE_URL}/calculator/overpayment#term` },
    { name: 'Нажмите «Узнать правду»', text: 'Увидите реальную переплату по кредиту', url: `${SITE_URL}/calculator/overpayment` },
    { name: 'Сравните банки', text: 'Узнайте сколько сэкономите при выборе лучшего банка', url: `${SITE_URL}/calculator/overpayment#comparison` },
];

const OverpaymentCalculatorPage = () => {
    const calculatorSchema = generateCalculatorSchema(
        'Калькулятор переплаты по ипотеке',
        'Узнайте реальную переплату по ипотеке. Сравните ставки банков и найдите способ сэкономить на процентах.',
        `${SITE_URL}/calculator/overpayment`,
        'FinanceApplication'
    );
    ...
    const howToSchema = generateHowToSchema(
        ...
        'Пошаговая инструкция по расчёту реальной переплаты по ипотечному кредиту',
        `${SITE_URL}/calculator/overpayment`,
        howToSteps
    );
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white py-12 md:py-20">
            <SEO
                title="Калькулятор переплаты по ипотеке — узнайте реальную стоимость кредита"
                description="Рассчитайте реальную переплату по ипотеке. Узнайте сколько подарите банку за весь срок. Сравните ставки банков и найдите способ сэкономить до сотен тысяч рублей."
                keywords="калькулятор переплаты ипотеки, переплата по ипотеке, сколько переплачу банку, реальная стоимость ипотеки, сравнение ставок ипотеки"
                canonical={`${SITE_URL}/calculator/overpayment`}
