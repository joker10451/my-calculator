  ...
  private getMockBanks(): Bank[] {
    return [
      ...
      },
      {
        ...
        name: 'Т-Банк',
        short_name: 'Т-Банк',
        logo_url: '/banks/tbank.png',
        website_url: 'https://tbank.ru',
        overall_rating: 4.5,
        customer_service_rating: 4.6,
        reliability_rating: 4.3,
        processing_speed_rating: 4.8,
        is_partner: true,
        commission_rate: 0.15,
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString()
      },
      {
        ...
        logo_url: '/banks/gazprombank.png',
        website_url: 'https://gazprombank.ru',
        overall_rating: 4.1,
        customer_service_rating: 4.0,
        reliability_rating: 4.2,
        processing_speed_rating: 4.0,
        is_partner: false,
      ...
      },
      {
        ...
        name: 'Росбанк',
        short_name: 'Росбанк',
        logo_url: '/banks/rosbank.png',
        website_url: 'https://rosbank.ru',
        overall_rating: 3.9,
        customer_service_rating: 3.8,
  ...
  private getMockProducts(): Product[] {
    return [
      ...
      },
      {
        ...
        product_type: 'mortgage',
        name: 'Ипотека онлайн',
        description: 'Оформление ипотеки полностью онлайн без визита в офис',
        interest_rate: 24.1,
        min_amount: 500000,
        max_amount: 15000000,
        min_term: 12,
        max_term: 360,
        fees: { application: 0, monthly: 0 },
        requirements: { min_income: 40000, min_age: 21 },
      ...
      },
      {
        ...
        description: 'Льготная ипотека с государственной поддержкой',
        interest_rate: 22.7,
        min_amount: 500000,
        max_amount: 25000000,
        min_term: 12,
      ...
      },
      {
        ...
        product_type: 'deposit',
        name: 'Лучший %',
        description: 'Вклад с максимальной ставкой для новых клиентов',
        interest_rate: 19.5,
        min_amount: 100000,
      ...
      },
      {
        ...
        product_type: 'deposit',
        name: 'Надёжный',
        description: 'Вклад с повышенной ставкой и капитализацией',
        interest_rate: 20.0,
        min_amount: 30000,
        max_amount: 50000000,
        min_term: 6,
        ...
        fees: {},
        requirements: { min_age: 18 },
        features: { capitalization: true, replenishment: false },
        available_regions: ['all'],
        is_active: true,
        is_featured: true,
        priority: 8,
      ...
      },
      {
        ...
        product_type: 'deposit',
        name: 'Т-Вклад',
        description: 'Откройте вклад онлайн за 2 минуты',
        interest_rate: 20.5,
        min_amount: 50000,
        max_amount: 30000000,
        min_term: 3,
      ...
      },
      {
        ...
        description: 'Потребительский кредит без залога и поручителей',
        interest_rate: 24.5,
        min_amount: 30000,
        max_amount: 7500000,
        min_term: 12,
      ...
      },
      {
        ...
        max_term: 60,
        fees: { application: 0, monthly: 0 },
        requirements: { min_income: 35000, min_age: 21 },
        features: { early_repayment: true, online_application: true },
        available_regions: ['all'],
        is_active: true,
        is_featured: true,
      ...
      },
      {
        ...
        product_type: 'credit',
        name: 'Кредит наличными',
        description: 'Быстрое одобрение и выдача в день обращения',
        interest_rate: 23.5,
        min_amount: 30000,
        max_amount: 5000000,
        min_term: 12,
        max_term: 84,
        fees: { application: 0, monthly: 0 },
        requirements: { min_income: 25000, min_age: 21 },
        features: { early_repayment: true, online_application: true },
        available_regions: ['all'],
        is_active: true,
        is_featured: true,
      ...
      },
      {
        ...
        product_type: 'card',
        name: 'Т-Банк Чёрный',
        description: 'Дебетовая карта с кэшбэком и процентом на остаток',
        interest_rate: 5.0,
        min_amount: 0,
        max_amount: 0,
        min_term: 0,
        ...
        fees: { monthly: 0 },
        requirements: { min_age: 18 },
        features: { cashback: true, online_application: true },
        available_regions: ['all'],
        is_active: true,
        is_featured: true,
        priority: 10,
      ...
      },
      {
        ...
        product_type: 'card',
        name: 'СберКарта',
        description: 'Универсальная карта с бонусами Спасибо',
        interest_rate: 3.5,
        min_amount: 0,
        max_amount: 0,
        min_term: 0,
      ...
      },
      {
        ...
        product_type: 'card',
        name: 'Альфа-Карта',
        description: 'Кэшбэк до 33% у партнёров и до 10% в категориях',
        interest_rate: 4.0,
        min_amount: 0,
        max_amount: 0,
        min_term: 0,
