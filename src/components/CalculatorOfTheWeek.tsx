...
import { Flame, ArrowRight, Trophy, Sparkles, TrendingUp } from 'lucide-react';
...
const CHALLENGES: WeeklyChallenge[] = [
  ...
  // Новые challenges
  {
    ...
    weekNumber: 7,
    title: 'Сила сложного процента — сколько накопите?',
    description: 'Даже 10 000 ₽/мес превращаются в миллионы за 10 лет. Проверьте на своих цифрах.',
    challenge: 'Введите сумму пополнения и ставку — увидите магию капитализации',
    calculatorName: 'Сложный процент',
    calculatorHref: '/calculator/compound-interest',
    icon: TrendingUp,
    accentColor: 'text-green-400',
    bgColor: 'bg-green-500/10',
    borderColor: 'border-green-500/20',
    badge: 'Инвестиции',
    fact: 'При 17% годовых и 10 000 ₽/мес за 10 лет вы получите более 3 млн ₽',
  },
  {
    id: 'rent-vs-buy',
    weekNumber: 8,
    title: 'Аренда или покупка — что выгоднее?',
    description: 'Ответ зависит от ставки, роста цен и срока. Рассчитайте для своей ситуации.',
    challenge: 'Введите стоимость квартиры и аренду — узнаете что выгоднее',
    calculatorName: 'Аренда vs Покупка',
    calculatorHref: '/calculator/rent-vs-buy',
    icon: Trophy,
    accentColor: 'text-indigo-400',
    bgColor: 'bg-indigo-500/10',
    borderColor: 'border-indigo-500/20',
    badge: 'Жильё',
    fact: 'При ставке выше 12% аренда часто выгоднее покупки на горизонте 5–7 лет',
  },
  {
    id: 'budget',
    weekNumber: 9,
    title: 'Правило 50/30/20 — сколько откладывать?',
    description: 'Простая формула распределения дохода. Узнайте свою идеальную сумму сбережений.',
    challenge: 'Введите доход — калькулятор покажет сколько на что тратить',
    calculatorName: 'Бюджет 50/30/20',
    calculatorHref: '/calculator/budget',
    icon: Sparkles,
    accentColor: 'text-amber-400',
    bgColor: 'bg-amber-500/10',
    borderColor: 'border-amber-500/20',
    badge: 'Планирование',
    fact: '20% дохода на сбережения — минимум для финансовой подушки за 6 месяцев',
  },
  {
    id: 'self-employed',
    weekNumber: 10,
    title: 'ИП или самозанятость — где больше на руки?',
    description: 'Разница в налогах может составлять десятки тысяч в год. Сравните режимы.',
    challenge: 'Введите доход — увидите чистую прибыль при каждом режиме',
    calculatorName: 'Калькулятор самозанятого',
    calculatorHref: '/calculator/self-employed',
    icon: Flame,
    accentColor: 'text-teal-400',
    bgColor: 'bg-teal-500/10',
    borderColor: 'border-teal-500/20',
    badge: 'Бизнес',
    fact: 'Самозанятые платят 4–6% налога, ИП на УСН — 6% или 15% от разницы',
  },
  {
    id: 'tax-deduction',
    weekNumber: 11,
    title: 'Государство должно вам деньги — проверьте',
    description: 'Налоговый вычет за квартиру, лечение, обучение. Многие не знают что им положено.',
    challenge: 'Выберите тип вычета — узнаете сколько вернут',
    calculatorName: 'Налоговый вычет',
    calculatorHref: '/calculator/tax-deduction',
    icon: Trophy,
    accentColor: 'text-lime-400',
    bgColor: 'bg-lime-500/10',
    borderColor: 'border-lime-500/20',
    badge: 'Возврат денег',
    fact: 'Максимальный имущественный вычет — 260 000 ₽ (13% от 2 млн)',
  },
  {
    id: 'refinancing',
    weekNumber: 12,
    title: 'Можно ли снизить платёж по кредиту?',
    description: 'Если ваша ставка выше текущей ключевой + 2% — рефинансирование выгодно.',
    challenge: 'Введите текущие условия — калькулятор покажет экономию',
    calculatorName: 'Рефинансирование',
    calculatorHref: '/calculator/refinancing',
    icon: Sparkles,
    accentColor: 'text-sky-400',
    bgColor: 'bg-sky-500/10',
    borderColor: 'border-sky-500/20',
    badge: 'Экономия',
    fact: 'Рефинансирование выгодно если разница ставок > 2% и осталось > 2 лет',
  },
  {
    id: 'alimony',
    weekNumber: 13,
    title: 'Алименты — точная сумма по закону',
    description: 'Размер алиментов зависит от дохода и количества детей. Рассчитайте по формуле.',
    challenge: 'Введите доход и количество детей — узнаете точную сумму',
    calculatorName: 'Калькулятор алиментов',
    calculatorHref: '/calculator/alimony',
    icon: Flame,
    accentColor: 'text-rose-400',
    bgColor: 'bg-rose-500/10',
    borderColor: 'border-rose-500/20',
    badge: 'Семья',
    fact: 'На 1 ребёнка — 25% дохода, на 2 — 33%, на 3+ — 50%',
  },
];
