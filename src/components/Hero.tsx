...
const Hero = () => {
  ...
  return (
    <div className="relative w-full">
      <AuroraBackground>
        <BackgroundBeamsWithCollision className="h-auto pt-4 pb-8 md:pt-6 md:pb-16 bg-transparent">
          <div className="container relative z-20 px-4 mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-3 py-1 mb-4 md:mb-6 text-sm font-medium border rounded-full bg-background/50 backdrop-blur-sm border-primary/20 text-primary">
