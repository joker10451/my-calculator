...
const MortgageCalculator = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <HowToUseSection
        steps={[
          { title: "Введите стоимость недвижимости" },
          { title: "Укажите размер первоначального взноса" },
          { title: "Выберите срок кредитования и процентную ставку" },
          { title: "Добавьте досрочные платежи для расчета экономии" }
        ]}
      />
    </div>
  );
