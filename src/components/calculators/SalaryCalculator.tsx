...
const SalaryCalculator = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <HowToUseSection
        steps={[
          { title: "Введите размер вашей зарплаты (до налогов)" },
          { title: "Просмотрите расчет зарплаты на руки" },
          { title: "Изучите детальную разбивку налогов" },
          { title: "Сохраните или экспортируйте результаты" }
        ]}
      />
    </div>
  );
