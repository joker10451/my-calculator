  ...
  return (
    <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border">
      <div className="container mx-auto relative">
          ...
          <div className="hidden md:flex flex-1 max-w-md relative mr-4">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full h-10 pl-10 pr-4 rounded-lg border bg-muted/50 focus:bg-background transition-colors focus:ring-2 focus:ring-primary/20 outline-none"
                value={searchQuery}
                onChange={(e) => {
            ...
            {isSearchOpen && searchQuery && (
              <div className="absolute top-full left-0 right-0 mt-2 bg-card border rounded-xl shadow-lg p-2 max-h-80 overflow-y-auto animate-fade-in">
        ...
        {isSearchOpen && (
          <div className="md:hidden absolute top-16 left-0 right-0 bg-background border-b p-4 animate-fade-in shadow-lg">
            <input
              ref={inputRef}
              type="text"
              placeholder="Поиск..."
              className="w-full h-12 pl-4 pr-4 rounded-lg border bg-muted focus:bg-background outline-none mb-2"
              value={searchQuery}
